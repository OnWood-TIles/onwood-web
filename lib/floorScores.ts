...
// Scores set by Reagan via /floor-scores-editor (2026-08-17).
export const FLOORS: Floor[] = [
  { name: "Porcelain tile", tag: "stone, marble & concrete look", scores: [3, 5, 5, 5, 2, 5, 1, 5, 5, 5] },
  { name: "Timber-look porcelain", tag: "wood look, tile tough", scores: [3, 4, 5, 5, 2, 2, 1, 5, 5, 5] },
  { name: "Luxury vinyl plank", tag: "LVP, flexible", scores: [4, 3, 3, 4, 4, 4, 4, 5, 4, 5] },
  { name: "Hybrid flooring", tag: "SPC, rigid core", scores: [4, 4, 3, 4, 4, 4, 4, 5, 3, 3] },
  { name: "Polished concrete", tag: "ground & sealed slab", scores: [3, 4, 5, 5, 2, 3, 1, 4, 5, 5] },
  { name: "Natural stone", tag: "marble, travertine, slate", scores: [1, 5, 5, 4, 2, 4, 1, 2, 5, 5] },
  { name: "Laminate", tag: "click-together boards", scores: [4, 5, 4, 2, 4, 4, 4, 5, 3, 1] },
  { name: "Engineered / solid timber", tag: "real hardwood", scores: [3, 5, 2, 1, 4, 4, 4, 4, 3, 3] },
  { name: "Carpet", tag: "wool or synthetic pile", scores: [5, 3, 2, 2, 2, 3, 5, 2, 5, 3] },
];
